...
public class UpdateAccountProcController implements Controller {
    private static final String METHOD = "POST";

    @Override
    public String getMethod() {
        return UpdateAccountProcController.METHOD;
    }
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("message", "거래처 수정에 오류가 발생 하였습니다.");
        request.setAttribute("target", "/admin/updateAccount.do?id=" + dto.getAccountId());
        return "/admin/script/redirect.jsp";
    }
}
